...
export default function SignIn() {
  ...
  <div className="w-2 h-2 rounded-full bg-white animate-bounce [animation-delay:-.5s] mt-3"></div>
      ...
      <div className="flex items-center justify-between mt-4">
        <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4" />Dont have an account?
        <a
  ...
  {error && <div className="flex flex-col gap-2 w-100% sm:w-100% text-[10px] sm:text-xs z-50">
