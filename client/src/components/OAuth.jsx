...
export default function OAuth() {
  ...
  return (
    <div className="flex justify-center w-full items-center">
        <div>
          <button onClick={handleGoogleClick} type='button' className="flex items-center justify-center py-2 mt-3 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
            <svg
              viewBox="0 0 24 24"
              height={25}
              width={25}
